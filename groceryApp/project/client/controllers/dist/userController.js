...
var _this = this;
var handleGetUsers = function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 6, , 8]);
                    return [4 /*yield*/, fetch("http://localhost:5500/user/add-user", {
                            method: "POST",
                            headers: {
...
function handleLogin(ev) {
    try {
        var nameInput = document.querySelector("#loginName__Input");
        var passwordInput = document.getElementById("loginPassword__Input");
        if (!nameInput)
